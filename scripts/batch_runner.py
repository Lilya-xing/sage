...
def build_command(
    ...
    args = [
        ...
        sae_path,
        "--features",
        f"layer{extract_layer_index(neuronpedia_source)}={feature}",
...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--target-llm", default="Qwen/Qwen3-4B", help="Target LLM / model name.")
    parser.add_argument("--neuronpedia-model-id", default="qwen3-4b", help="Neuronpedia model ID.")
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=[10],
        help="Exemplar top_k values; the paper main experiment uses 10.",
    )
    parser.add_argument(
        "--gpus",
        type=int,
