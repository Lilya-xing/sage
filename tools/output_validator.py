...
class OutputValidator:
    ...
    def __init__(self, top_k: int = 10, initial_hypotheses: int = 4):
        self.top_k = top_k
    ...
    def _validate_observation(self, output: str) -> Tuple[bool, str]:
        ...
        # The main paper specifies exactly four initial hypotheses.
        hypothesis_count = len(re.findall(hypothesis_pattern, output))
        if hypothesis_count != self.initial_hypotheses:
            return False, f"Found {hypothesis_count} hypotheses. Need exactly {self.initial_hypotheses}."
    ...
    def _validate_hypothesis_list(self, output: str) -> Tuple[bool, str]:
        ...
        # Keep the initial hypothesis count explicit and reproducible.
        hypothesis_count = len(re.findall(hypothesis_pattern, output))
        if hypothesis_count != self.initial_hypotheses:
            return False, f"Found {hypothesis_count} hypotheses. Need exactly {self.initial_hypotheses}."
